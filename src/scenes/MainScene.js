...
export default class MainScene extends phaser.Scene {
    ...
    create() 
    {
        ...
        this.nextNumberBoxImage = this.add.image(1465, 965, 'PuzzleStages', 'icon_01');

        //checks the spawn areas and if it is full or not
        this.verticalRectCheck1 = this.physics.add.image(1120, 800)
        this.verticalRect1 = this.add.image(1127, 885, 'PuzzleStages', 'icon_01').setScale(1, 5).setOrigin(0.5, 1)
            .setInteractive()
        ...
        this.verticalRect2 = this.add.image(1296, 885, 'PuzzleStages', 'icon_01').setScale(1, 5).setOrigin(0.5, 1)
            .setInteractive()
        ...
        this.verticalRect3 = this.add.image(1465, 885, 'PuzzleStages', 'icon_01').setScale(1, 5).setOrigin(0.5, 1)
            .setInteractive()
        ...
        this.verticalRect4 = this.add.image(1634, 885, 'PuzzleStages', 'icon_01').setScale(1, 5).setOrigin(0.5, 1)
            .setInteractive()
        ...
        this.verticalRect5 = this.add.image(1803, 885, 'PuzzleStages', 'icon_01').setScale(1, 5).setOrigin(0.5, 1)
            .setInteractive()
    ...
    SpawnNewNumberBox(posX, posY, checkerRect) 
    {
        ...
        this.latestSpawnedNumberBox = new NumberBox(this, posX, posY, 'PuzzleStages', 'icon_01', this.nextnumberToSpawn, -600, bounds, SquaresArray);
    ...
    AdjustNextBoxImage() 
    {
        ...
        {
            case 0.5:
                this.nextNumberBoxImage.setTexture('PuzzleStages', 'icon_01');
                break;
            case 1:
                this.nextNumberBoxImage.setTexture('PuzzleStages', 'icon_01');
                break;

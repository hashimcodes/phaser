...
export default class NumberBox extends phaser.Physics.Arcade.Image {
    constructor(scene, x, y, atlasKey, textureKey, number, velocityY, collisionCol, overlapCol) {
        super(scene, x, y, atlasKey, textureKey)
        this.alpha = 0.01;
        this.value = number;
        this.scene = scene;
        ...
        this.mainImage = scene.add.image(0, 0, 'PuzzleStages', 'icon_01');
    ...
    AdjustMainImage() {
        switch (this.value) {
            case 0.5:
                this.mainImage.setTexture('PuzzleStages', 'icon_01')
